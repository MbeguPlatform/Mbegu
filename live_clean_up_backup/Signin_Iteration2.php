...
<div class="header">
<div class="logo">
  <img id="mLogo" alt="" data-type="image" src="https://static.wixstatic.com/media/892132_939375ed638248f7b7322dd16f9a532d~mv2.png/v1/fill/w_442,h_197,al_c,q_80,usm_2.00_1.00_0.00/892132_939375ed638248f7b7322dd16f9a532d~mv2.webp"/>  
</div>
</div>
...
<div class="data">
    <p id="profileText"> Profile Details</p>
    <img id="pic" class="img-circle" width="100" height="100"/>
    <br/><br/>
    <p> Email Address: </p>
    <p id="email"></p>
    <hr/>
<button onclick="Reg()">Register an Idea</button>
